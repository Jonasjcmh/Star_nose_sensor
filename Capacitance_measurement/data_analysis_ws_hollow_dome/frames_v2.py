...
if __name__ == '__main__':
    ...
    df = pd.read_csv('/home/divuthejo/Downloads/ramp_collector_20260626_171140_7mm.csv')
    output_dir = '/home/divuthejo/Documents/data_analysis_ws/plots_7mm'
    os.makedirs(output_dir, exist_ok=True)

    depth = 7.0  # change this to the raw depth_mm value in whatever file you're running
